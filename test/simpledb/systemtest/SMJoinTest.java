...
public class SMJoinTest {
    ...
    public void performSortedJoin(double table1Duplicate, int table1Rows, double table2Duplicate, int table2Rows, boolean printTable)
            throws IOException, DbException, TransactionAbortedException {
        // Create the two tables
        ArrayList<ArrayList<Integer>> t1Tuples = new ArrayList<ArrayList<Integer>>();
        HeapFile table1 = SystemTestUtil.createSortedFile(COLUMNS, table1Rows, table1Duplicate, t1Tuples, printTable);
        ...
        HeapFile table2 = SystemTestUtil.createSortedFile(COLUMNS, table2Rows, table2Duplicate, t2Tuples, printTable);
...
//    @Test
//    public void testSmallCrossProduct() throws IOException, DbException, TransactionAbortedException {
//        System.out.println("--------------------------------------------");
...
//
//    @Test
//    public void testLargeCrossProduct() throws IOException, DbException, TransactionAbortedException {
//        System.out.println("--------------------------------------------");
//        System.out.println("JoinTest - Test CrossProduct");
...
//
//    @Test
//    public void testUniqueOuter() throws IOException, DbException, TransactionAbortedException {
//        System.out.println("--------------------------------------------");
...
//
//    @Test
//    public void testUniqueInner() throws IOException, DbException, TransactionAbortedException {
//        System.out.println("--------------------------------------------");
...
//
//    @Test
//    public void testMultipleOuterInner() throws IOException, DbException, TransactionAbortedException {
//        System.out.println("--------------------------------------------");
