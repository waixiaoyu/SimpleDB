...
public class HeapFile implements DbFile {
    ...
    /**
     * Constructor. Creates a new heap file that stores pages in the specified
     * buffer pool.
     *
     * @param f
     *            The file that stores the on-disk backing store for this
     *            DbFile.
     */
    ...
    /**
     * @return an ID uniquely identifying this HeapFile (Implementation note:
     *         you will need to generate this tableid somewhere, ensure that
     *         each HeapFile has a "unique id," and that you always return the
     *         same value for a particular HeapFile. The implementation we
     *         suggest you use could hash the absolute file name of the file
    ...
    /**
     * An iterator over all tuples on this file, over all pages. Note that this
     * iterator should use BufferPool.getPage(), rather than HeapFile.getPage()
    ...
    /**
     * @return the number of bytes on a page, including the number of bytes in
     *         the header.
     */
