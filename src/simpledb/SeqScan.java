...
public class SeqScan implements DbIterator {
    ...
    /**
     * Constructor. Creates a sequential scan over the specified table as a part
    ...
    /**
     * Implementation of DbIterator.getTupleDesc method. Should return a
     * tupleDesc with field names from the underlying HeapFile with field names
     * prefaced by the passed in tableAlias string
     */
    ...
    /**
     * Implementation of DbIterator.getNext method. Return the next tuple in the
     * scan, or null if there are no more tuples.
     *
     */
